...
class PinCodeVerifyPassreset extends StatefulWidget {
  const PinCodeVerifyPassreset({Key? key}) : super(key: key);

  @override
  State<PinCodeVerifyPassreset> createState() => _PinCodeVerifyPassresetState();
}

class _PinCodeVerifyPassresetState extends State<PinCodeVerifyPassreset> {
  late Timer _timer;
